...
# Create the layout of the app #TASK 2.1 Add title to the dashboard #May include style for title
app.layout = html.Div([
...
#TASK 2.4: Creating Callbacks # Callback for updating the input container
@app.callback(
...
# TASK 2.6: Create and display graphs for Yearly Report Statistics
 # Yearly Statistic Report Plots                             
        ...
        try:
            ...
            return [html.Div("Invalid year provided. Please select a valid year.")]
